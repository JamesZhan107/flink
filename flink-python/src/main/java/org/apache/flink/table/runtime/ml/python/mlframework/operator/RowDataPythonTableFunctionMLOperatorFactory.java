...
public class RowDataPythonTableFunctionMLOperatorFactory extends AbstractStreamOperatorFactory<RowData> implements CoordinatedOperatorFactory<RowData> {

	RowDataPythonTableFunctionMLOperator mlOperator;

	public RowDataPythonTableFunctionMLOperatorFactory(RowDataPythonTableFunctionMLOperator mlOperator) {
